...
| [Artix from Froyo](https://github.com/VanilliteFroyo/Artix-PS4/releases/tag/Artix)		      | Aeolia, Belize<br>(Mesa 26) 	  | [VanilliteFroyo](https://github.com/VanilliteFroyo) | Artix with dinit, not for linux begginers							      |
| [Artix](https://github.com/ErkkolaMaitohappo/ps4-arch-based-distros/releases/tag/artix-ps4-V1)                       | Aeolia, Belize<br>(Mesa 25.3.3)   | [Erkkola](https://github.com/ErkkolaMaitohappo) | artix dinit, openrc, runit or s6. not for linux begginers.                                                                                    |
