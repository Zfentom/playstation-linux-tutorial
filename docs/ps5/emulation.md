...
- Download the emulator from their official site [here](https://shadps4.net/downloads/).

- Pick linux and run the Qt Launcher, though make sure you have ran ``chmod +x shadPS4QtLauncher-qt.AppImage`` 

- Click on the ``Version Manager`` and click the latest version on the right

>**Note that most versions of shadps4 now are nightly releases and those are considered unstable**
